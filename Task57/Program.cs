...
int[] MatrixToArray(int[,] matrix) // Двумерный массив заталкивают в одномерный массив.
{
    int k = 0;
...
// 1 1 5 5 6 6 9 9
void PrintFrequencyDictionary(int[] array) // Функция считает количество разных чисел в массиве.
{
    int count = 1;
